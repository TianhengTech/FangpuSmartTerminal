...
namespace fangpu_terminal
{
    class TerminalCommon
    {
        ...
        */
        ...
        public static string S71200AreaI = "I";
        public static string S71200AreaQ = "Q";
        public static string S71200AreaM = "M";
        public static string S71200AreaDB = "DB";
        ...
        public static string S71200DataByte = "byte";
        public static string S71200DataBit = "bit";
        public static string S71200DataWord = "word";
        public static string S71200DataDword = "dword";
        ...
        public static Dictionary<string, string> warn_info_PLC1 = new Dictionary<string, string>();
        public static Dictionary<string, string> warn_info_PLC2 = new Dictionary<string, string>();
        //获取内网IP
