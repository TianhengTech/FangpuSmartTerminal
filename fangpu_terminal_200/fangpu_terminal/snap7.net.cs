...
namespace Snap7
{
    ...
    public class S7Client
    {
        ...
        public int Tread(int Start, int Amount, int WordLen, IntPtr Pointer)
        {
            return Cli_ReadArea_ptr(Client, 0x1F, 0, Start, Amount, WordLen, Pointer);
        }
        public int Cread(int Start, int Amount, int WordLen, IntPtr Pointer)
        {
            return Cli_ReadArea_ptr(Client, 0x1F, 0, Start, Amount, WordLen, Pointer);
        }
        [DllImport(S7Consts.Snap7LibName)]
        ...
        public int Vread(int Start,int Size,byte[] Buffer)
        {
            return Cli_DBRead(Client, 1, Start, Size, Buffer);
        }
        [DllImport(S7Consts.Snap7LibName)]
        ...
        public int VWrite(int Start, int Size, byte[] Buffer)
        {
            return Cli_DBWrite(Client, 1, Start, Size, Buffer);
        }
